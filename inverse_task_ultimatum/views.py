...
class Task(Page):
	...
	def before_next_page(self):
		if self.timeout_happened:
			...
			self.player.slider21 = int(post_dict['slider21'])
			self.player.slider22 = int(post_dict['slider22'])
			self.player.slider23 = int(post_dict['slider23'])
			self.player.slider24 = int(post_dict['slider24'])
			self.player.slider25 = int(post_dict['slider25'])
			self.player.slider26 = int(post_dict['slider26'])
			self.player.slider27 = int(post_dict['slider27'])
			self.player.slider28 = int(post_dict['slider28'])
			self.player.slider29 = int(post_dict['slider29'])
			self.player.slider30 = int(post_dict['slider30'])
...
# Il receiver a seconda di quante slider ha eseguito, chiede al proposer il suo claim (non usata nell'inverse)
class Claim(Page):
...
class Proposal(Page):
	...
	def vars_for_template(self):
	 	return {'task_correct': 10-self.group.task_correct}
